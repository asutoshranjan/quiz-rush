...
export default function RedeemCard() {
                  ...
                  <div className="space-y-1">
                    <p className="text-gray-800">
                      ...
                      <span className="break-all">
                        {payoutData.txnSignature}
                      </span>
                    </p>
                    <p className="text-gray-800">
                      <span className="font-medium">Amount:</span>{" "}
                      {payoutData.value} SOL
                    </p>
                    <p className="text-gray-800">
  ...
  if (!data) {
    return <div className="flex min-h-80 items-center space-x-4"></div>;
  } else {
    return (
        ...
        <div className="flex flex-col justify-center z-10">
          ...
          <div className="flex flex-col flex-1 justify-center items-center">
            <div className="mt-6  flex flex-col justify-center items-center">
              <p className="text-gray-800 font-Inter text-2xl font-semibold">
                Total Points
              </p>
              <p className="text-light-blue text-2xl font-bold mb-4">
                {data.points}
              </p>
            </div>
